                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-2 col-12 form-group mandatory">
                            ...
                            {{ Form::number('duration', '', ['class' => 'form-control ', 'placeholder' => 'Package Duration (in days)', 'data-parsley-required' => 'true','id' => 'duration', 'min' => '1']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12" id="limitation_for_property">
                                        ...
                                        {{ Form::number('property_limit', '', ['class' => 'form-control ', 'placeholder' => 'limitation', 'id' => 'property_limit','min'=>0]) }}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 form-group " id="limitation_for_advertisement">
                                        ...
                                        {{ Form::number('advertisement_limit', '', ['class' => 'form-control ', 'placeholder' => 'limitation ', 'id' => 'advertisement_limit','min'=>0]) }}
